# Generated by Django 4.2 on 2023-04-16 08:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='User',
            fields=[
                ('id', models.IntegerField(db_index=True, primary_key=True, serialize=False, verbose_name='用户id')),
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, max_length=128, verbose_name='注册时间')),
